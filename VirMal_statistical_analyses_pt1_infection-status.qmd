...
Note about effect size: Effect size with contingency tables larger than 2x2 will be calculated with CramerV function (species comparison). Whereas 2x2 contingency tables will be calculated by phi function (all other chi-squared).
...
## Plumbeous Vireo: Significant MW-U (p-value = 0.022, r = 0.305)
...
Hp_Lat_bar <- ggplot(df_p_hp, 
  ...
  labs(x = "Latitude (degrees)",y = "Proportion", fill = "Infection Status",
    title = "Proportion of infected vs. uninfected vireos by latitude") +
  theme_minimal() +
  theme(plot.title.position = "plot", # parameter "plot" makes "title" flush with y-axis
        plot.title = element_text(face="bold")) + 
  theme(legend.position = "blank") +
...
Plum_Lat_bar <- ggplot(Plum_p_hp1, 
  ...
  #labs(x = "Latitude (degrees)",y = "Proportion", fill = "Infection Status",
  #  title = "Proportion of infected vs. uninfected Plumbeous vireos by latitude") +
  theme_minimal() +
  theme(plot.title.position = "plot", # parameter "plot" makes "title" flush with y-axis
        plot.title = element_text(face="bold")) + 
  theme(legend.position = "blank") + # use: legend.position = "bottom", legend.box = "horizontal" in   single plots
...
plot(combined_plot)
 ggsave(combined_plot, filename="FigS2.pdf", bg="transparent", height=10, width=10, units="in")
```
...
Hp_TPC1_bar <- ggplot(df_p_hp, 
  ...
  labs(x = "TPC1",y = "Proportion", fill = "Infection Status",
    title = "Proportion of infected vs. uninfected vireos by TPC1") +
  theme_minimal() +
  theme(plot.title.position = "plot", # parameter "plot" makes "title" flush with y-axis
        plot.title = element_text(face="bold")) + 
  theme(legend.position = "blank") +
...
Plum_TPC1_bar <- ggplot(Plum_p_hp1, 
  ...
  scale_fill_manual(values = Plum_c) + # Apply custom colors
  #labs(x = "TPC1 (degrees)",y = "Proportion", fill = "Infection Status",
  #  title = "Proportion of infected vs. uninfected Plumbeous vireos by TPC1") +
  theme_minimal() +
  theme(plot.title.position = "plot", # parameter "plot" makes "title" flush with y-axis
        plot.title = element_text(face="bold")) + 
  theme(legend.position = "blank") + # use: legend.position = "bottom", legend.box = "horizontal" in   single plots
...
combined_plot <- combined_plot + theme(aspect.ratio = 1) 
plot(combined_plot)
 ggsave(combined_plot, filename="FigS3.pdf", bg="transparent", height=10, width=10, units="in") 
```
...
Hp_TPC2_bar <- ggplot(df_p_hp, 
  ...
  labs(x = "TPC2",y = "Proportion", fill = "Infection Status",
    title = "Proportion of infected vs. uninfected vireos by TPC2") +
  theme_minimal() +
  theme(plot.title.position = "plot", # parameter "plot" makes "title" flush with y-axis
        plot.title = element_text(face="bold")) + 
  theme(legend.position = "blank") +
...
Plum_TPC2_bar <- ggplot(Plum_p_hp1, 
  ...
  scale_fill_manual(values = Plum_c) + # Apply custom colors
  #labs(x = "TPC2 (degrees)",y = "Proportion", fill = "Infection Status",
  #  title = "Proportion of infected vs. uninfected Plumbeous vireos by TPC2") +
  theme_minimal() +
  theme(plot.title.position = "plot", # parameter "plot" makes "title" flush with y-axis
        plot.title = element_text(face="bold")) + 
  theme(legend.position = "blank") + # use: legend.position = "bottom", legend.box = "horizontal" in   single plots
...
combined_plot <- combined_plot + theme(aspect.ratio = 1) 
plot(combined_plot)
 ggsave(combined_plot, filename="FigS4.pdf", bg="transparent", height=10, width=10, units="in")
```
...
Hp_PPC1_bar <- ggplot(df_p_hp, 
  ...
  labs(x = "PPC1",y = "Proportion", fill = "Infection Status",
    title = "Proportion of infected vs. uninfected vireos by PPC1") +
  theme_minimal() +
  theme(plot.title.position = "plot", # parameter "plot" makes "title" flush with y-axis
        plot.title = element_text(face="bold")) + 
  theme(legend.position = "blank") +
...
Plum_PPC1_bar <- ggplot(Plum_p_hp1, 
  ...
  scale_fill_manual(values = Plum_c) + # Apply custom colors
  #labs(x = "PPC1 (degrees)",y = "Proportion", fill = "Infection Status",
  #  title = "Proportion of infected vs. uninfected Plumbeous vireos by PPC1") +
  theme_minimal() +
  theme(plot.title.position = "plot", # parameter "plot" makes "title" flush with y-axis
        plot.title = element_text(face="bold")) + 
  theme(legend.position = "blank") + # use: legend.position = "bottom", legend.box = "horizontal" in   single plots
...
combined_plot <- combined_plot + theme(aspect.ratio = 1) 
plot(combined_plot)
 ggsave(combined_plot, filename="FigS5.pdf", bg="transparent", height=10, width=10, units="in")
```
...
## All vireos: Significant MW-U (p-value = 0.002, r = 0.192)
...
Hp_PPC2_bar <- ggplot(df_p_hp, 
  ...
  labs(x = "PPC2",y = "Proportion", fill = "Infection Status",
    title = "Proportion of infected vs. uninfected vireos by PPC2") +
  theme_minimal() +
  theme(plot.title.position = "plot", # parameter "plot" makes "title" flush with y-axis
        plot.title = element_text(face="bold")) + 
  theme(legend.position = "blank") +
...
Plum_PPC2_bar <- ggplot(Plum_p_hp1, 
  ...
  scale_fill_manual(values = Plum_c) + # Apply custom colors
  #labs(x = "PPC2 (degrees)",y = "Proportion", fill = "Infection Status",
  #  title = "Proportion of infected vs. uninfected Plumbeous vireos by PPC2") +
  theme_minimal() +
  theme(plot.title.position = "plot", # parameter "plot" makes "title" flush with y-axis
        plot.title = element_text(face="bold")) + 
  theme(legend.position = "blank") + # use: legend.position = "bottom", legend.box = "horizontal" in   single plots
...
combined_plot <- combined_plot + theme(aspect.ratio = 1) 
plot(combined_plot)
 ggsave(combined_plot, filename="FigS6.pdf", bg="transparent", height=10, width=10, units="in")
```
