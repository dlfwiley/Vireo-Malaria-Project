...
p <- ggplot(data=df_p_hp, aes(x=TPC1, y=TPC2, color=common_name))
p <- p + geom_point(size=2.5)
p <- p + labs(x = "TPC1 54.3%", y = "TPC2 29.9%", color="Species")
p <- p + theme_bw()
...
p2 <- ggplot(data=df_p_hp, aes(x=PPC1, y=PPC2, color=common_name))
p2 <- p2 + geom_point(size=2.5)
p2 <- p2 + labs(x = "PPC1 62.6%", y = "PPC2 30.2%", color="Species")
p2 <- p2 + theme_bw()
